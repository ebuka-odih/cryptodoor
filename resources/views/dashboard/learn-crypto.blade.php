...
@section('content')
    ...
    <div class="main_content">
        <div class="container">
            ...
            <div class="text-2xl font-semibold"> Learn Crypto</div>
                    ...
                    <div class="divide-y tube-card px-6 md:m-0 -mx-5 py-2">
                        @foreach($news as $item)
                            <div class="md:flex md:space-x-6 py-5">
                                <a href="{{ route('user.learn.show', $item->id) }}">
                                ...
                                <div class="flex-1 md:pt-0 pt-4">
                                    ...
                                    <a href="{{ route('user.learn.show', $item->id) }}" class="text-lg font-semibold line-clamp-2 leading-8"> {{ $item->title }}</a>
                        ...
                        <div class="tube-card p-6">
                            ...
                            <ul>
                                @foreach($featured as $item)
                                    <li>
                                        <a href="{{ route('user.learn.show', $item->id) }}" class="hover:bg-gray-50 rounded-md p-2 -mx-2 block">

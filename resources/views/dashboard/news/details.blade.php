            ...
            <div class="lg:w-9/12 lg:space-y-6">
                ...
                <div class="tube-card">
                    ...
                    <div class="h-44 mb-4 md:h-72 overflow-hidden relative rounded-t-lg w-full">
                        <img src="{{ asset('cryptodoor/'.$new->image) }}" alt="" class="w-full h-full absolute inset-0 object-cover">
                    </div>

                    <div class="md:p-6 p-4">

                        <h1 class="lg:text-2xl text-xl font-semibold mb-6"> {{ $new->title }}</h1>
                        ...
                        <div class="flex items-center space-x-3 my-3 pb-4 border-b">
                            ...
                            <div>
                                ...
                                <div class="text-xs"> Published on {{ date('M d, Y', strtotime($new->created_at)) }} </div>
                            </div>
                        </div>
                        ...
                        <div class="relative">
                            <a href="#" class="mt-3 inline-flex items-center space-x-3" aria-expanded="false">
                                <ion-icon name="share-social-outline" class="p-2 rounded-md text-lg bg-gray-200 md hydrated" role="img" aria-label="share social outline"></ion-icon>
                                <div> Intersting?  <span class="text-blue-600">  Share it </span> </div>
                            </a>

                            <div class="bg-white w-96 shadow-md hidden mx-auto p-2 mt-12 rounded-md text-gray-500 border uk-drop" uk-drop="mode: hover;pos: right-center;animation: uk-animation-slide-right-small; offset:15" style="left: 194.219px; top: -68.5px;">

                                <div class="grid grid-flow-col text-sm w-full">
                                    <a href="#" class="p-2 text-center hover:bg-gray-100 rounded-md text-sm space-y-1"> <ion-icon name="logo-facebook" class="text-4xl md hydrated" role="img" aria-label="logo facebook"></ion-icon> <div> Facebook </div> </a>
                                    <a href="#" class="p-2 text-center hover:bg-gray-100 rounded-md text-sm space-y-1"> <ion-icon name="logo-facebook" class="text-4xl md hydrated" role="img" aria-label="logo facebook"></ion-icon> <div> Facebook </div> </a>
                                    <a href="#" class="p-2 text-center hover:bg-gray-100 rounded-md text-sm space-y-1"> <ion-icon name="logo-google" class="text-4xl md hydrated" role="img" aria-label="logo google"></ion-icon> <div> Facebook </div> </a>
                                    <a href="#" class="p-2  text-center hover:bg-gray-100 rounded-md text-sm space-y-1"> <ion-icon name="logo-twitter" class="text-4xl md hydrated" role="img" aria-label="logo twitter"></ion-icon> <div> Facebook </div> </a>
                                </div>
                            </div>
                        ...
                        <div class="uk-slider-container px-1 py-3">
                            <ul class="uk-slider-items uk-child-width-1-3@m uk-child-width-1-2@s uk-child-width-1-2 uk-grid-small uk-grid" style="transform: translate3d(-196.031px, 0px, 0px);">
                                <li tabindex="-1" class="">
                                    <div>
                                        <a href="blog-read.html" class="w-full md:h-32 h-28 overflow-hidden rounded-lg relative block">
                                            <img src="http://demo.foxthemes.net/courseplus-v4.3.1/assets/images/blog/img-1.jpg" alt="" class="w-full h-full absolute inset-0 object-cover">
                                        </a>
                                        <div class="pt-3">
                                ...
                                <li tabindex="-1" class="uk-active">
                                    <div>
                                        <a href="blog-read.html" class="w-full md:h-32 h-28 overflow-hidden rounded-lg relative block">
                                            <img src="http://demo.foxthemes.net/courseplus-v4.3.1/assets/images/blog/img-3.jpg" alt="" class="w-full h-full absolute inset-0 object-cover">
                                        </a>
                                        <div class="pt-3">
                                ...
                                <li tabindex="-1" class="uk-active">
                                    <div>
                                        <a href="blog-read.html" class="w-full md:h-32 h-28 overflow-hidden rounded-lg relative block">
                                            <img src="http://demo.foxthemes.net/courseplus-v4.3.1/assets/images/blog/img-4.jpg" alt="" class="w-full h-full absolute inset-0 object-cover">
                                        </a>
                                        <div class="pt-3">

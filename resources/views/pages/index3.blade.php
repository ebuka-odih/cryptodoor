...
<!-- Mirrored from themesbrand.com/qexal/layout/index-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Aug 2022 05:45:49 GMT -->
<head>
    <meta charset="utf-8" />
...
<nav class="navbar navbar-expand-lg fixed-top navbar-custom " id="navbar">
    <div class="container">
        ...
        <a class="navbar-brand logo" href="/">
            <img src="logo.png" alt="" class="logo-dark" height="28" />
            <img src="logo.png" alt="" class="logo-light" height="28" />
        </a>
        ...
        <div class="row align-items-center hero-content">
            ...
            <div class="col-lg-6 col-sm-10 mx-auto ms-lg-auto me-lg-0">
                <div class="mt-lg-0 mt-4">
                    <img src="img/bg.png" alt="" class="img-md-responsive" />
                </div>
            </div><!-- end col -->
        </div><!-- end row -->
                            ...
                            <div class="col-lg-4">
                                <div class="card plan-card mt-4 rounded text-center border-0 shadow overflow-hidden">
                                    <div class="card-body px-4 py-5">
                                        ...
                                        <p class="text-muted mb-4 pb-1">Domain 1</p>
                                        <p class="text-muted font-size-14 mb-1">All Extension Included</p>
                                        <p class="text-dark font-size-16 font-weight-semibold mb-4">$29.00 / Year</p>
                                        <a href="javascript: void(0);" class="btn btn-soft-primary">Buy Now</a>
                                    </div>
                                    <!-- end cardbody -->
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="card plan-card mt-4 rounded text-center border-0 shadow overflow-hidden">
                                    <div class="card-body px-4 py-5">
                                        ...
                                        <p class="text-muted mb-4 pb-1">Domain 1</p>
                                        <p class="text-muted font-size-14 mb-1">All Extension Included</p>
                                        <p class="text-dark font-size-16 font-weight-semibold mb-4">$49.00 / Year</p>
                                        <a href="javascript: void(0);" class="btn btn-soft-primary">Buy Now</a>
                                    </div>
                                    <!-- end cardbody -->
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="card plan-card mt-4 rounded text-center border-0 shadow overflow-hidden">
                                    <div class="card-body px-4 py-5">
                                        ...
                                        <p class="text-muted mb-4 pb-1">Domain 1</p>
                                        <p class="text-muted font-size-14 mb-1">All Extension Included</p>
                                        <p class="text-dark font-size-16 font-weight-semibold mb-4">$99.00 / Year</p>
                                        <a href="javascript: void(0);" class="btn btn-soft-primary">Buy Now</a>
                                    </div>
                                    <!-- end cardbody -->
                                </div>
...
<!-- Mirrored from themesbrand.com/qexal/layout/index-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Aug 2022 05:46:19 GMT -->
</html>

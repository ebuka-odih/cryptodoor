            ...
            <table class="table mg-b-0">
                ...
                <tr>
                    ...
                    <td>
                       <div class="row">
                            <div class="mr-3">
                                <a href="{{ route('admin.crypto-event.edit', $item->id) }}" class="btn btn-sm btn-primary">Edit</a>
                            </div>
                           <div class="">
                               <form method="POST" action="{!! route('admin.crypto-event.destroy', $item->id) !!}" accept-charset="UTF-8">
                                   <input name="_method" value="DELETE" type="hidden">
                                   {{ csrf_field() }}

                                   <div class="btn-group btn-group-xs pull-right" role="group">
                                       <button type="submit" class="btn btn-sm  btn-danger"  onclick="return confirm(&quot;Delete Event?&quot;)">
                                           Delete
                                       </button>

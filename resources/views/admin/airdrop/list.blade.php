...
<div class="br-pagebody">
    <div class="br-section-wrapper">
        <h6 class="br-section-label mb-3">All Crypto Airdrop / Giveaway</h6>
            ...
            <table class="table mg-b-0">
                ...
                <tr>
                    ...
                    <td>
                       <div class="row">
                            <div class="mr-3">
                                <a href="{{ route('admin.airdrop.edit', $item->id) }}" class="btn btn-sm btn-primary">Edit</a>
                            </div>
                           <div class="">
                               <form method="POST" action="{!! route('admin.airdrop.destroy', $item->id) !!}" accept-charset="UTF-8">

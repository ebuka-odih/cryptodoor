...
jQuery.support = (function() {
	...
	// Support: IE<9 (lack submit/change bubble), Firefox 17+ (lack focusin crypto-event)
	// Beware of CSP restrictions (https://developer.mozilla.org/en/Security/CSP), test.blade.php/csp.php
...
setDocument = Sizzle.setDocument = function( node ) {
	...
	if ( (support.qsa = isNative(doc.querySelectorAll)) ) {
		...
		assert(function( div ) {
			...
			// This is to test.blade.php IE's treatment of not explictly

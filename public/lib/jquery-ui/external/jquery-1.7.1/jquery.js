...
(function(){
	...
	if ( matches ) {
		...
		try {
			...
			matches.call( document.documentElement, "[test.blade.php!='']:sizzle" );
...
(function(){
	...
	div.innerHTML = "<div class='test.blade.php e'></div><div class='test.blade.php'></div>";
...
jQuery(function() {
	// This hook cannot be added until DOM ready because the support test.blade.php
